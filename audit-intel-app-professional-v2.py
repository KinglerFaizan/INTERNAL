...
<style>
    ...
    [data-testid="stSidebar"] { background:#eeeadd; border-right:1px solid #ddd6c6; }
    ...
    [data-testid="stSidebar"] .stRadio label p { font-size:13px; font-weight:750; }
    [data-testid="stSidebar"] .stMarkdown h1 { color:#182338; }
    [data-testid="stSidebar"] .stCaption { color:#817b6f; }
</style>
