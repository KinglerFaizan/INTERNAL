...
<style>
    ...
    /* ---------------- Editorial banking newsroom cards (image-top, 2-up) ---------------- */
    .insight-card {
        display:flex;
        flex-direction:column;
        height:100%;
    ...
    .insight-card:hover .insight-thumb { transform:scale(1.045); }
    .insight-thumb-scrim {
        position:absolute;
        inset:0;
        background:linear-gradient(180deg, rgba(11,18,32,0) 55%, rgba(9,14,26,.62) 100%);
        pointer-events:none;
    }
    .insight-meta-row {
        position:absolute;
    ...
    @media (max-width:900px) {
        .insight-thumb-wrap { height:220px; }
        .insight-title { font-size:17.5px; }
        .insight-desc { font-size:12px; }
    }
    @media (max-width:700px) {
        .insight-thumb-wrap { height:190px; }
        .insight-content { padding:16px 16px 16px; }
...
PRAGATI_PHOTO_B64 = (
    ...
    "JCQkJCQkJCQkJCQkJCQkJCQkJCQkJCQkJCQkJCQkJCQkJCQkJCQkJCT/wAARCADwAPADASIA"
...
def render_insight_card(article):
    ...
    <article class="insight-card">
        <div class="insight-thumb-wrap">
            ...
            />
            <div class="insight-thumb-scrim"></div>
            <div class="insight-meta-row">
                <span class="badge" style="background:{color}CC;border-color:rgba(255,255,255,.4);">{html.escape(label)}</span>
